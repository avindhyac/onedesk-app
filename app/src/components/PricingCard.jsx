...
export default function PricingCard({ name, price, period = "/ month", tagline, features = [], cta, featured = false }) {
  return (
      ...
      <ul className="pricing-card__features">
        {features.map((f) => (
          <li key={f} className="pricing-card__feature">
            <iconify-icon icon="lucide:check-circle-2" className="pricing-card__check" />
            {f}
          </li>
        ))}
      </ul>
