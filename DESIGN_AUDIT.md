...
---
6. Deployment (Vercel)
                                                                                       - Vercel auto-detects the Vite  essentially zero-config.
...
Mobile-specific fixes, prioritized:                                                    1. Re-export char-hr.webp (318  data hardest. (P0, easy)
2. Contact page: put the form before the info panel on mobile. (P1)                    3. Tap targets: pad footer link px. (P1)
4. Hidden menu links shouldn't be keyboard-focusable when the sheet is closed. (P1)
5. Confirmed fine, no change needed: menu sheet height, marquee overflow masking, hero stacking.
